...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct>0 then
		...
		e1:SetTarget(function(_,c) return c:IsCode(ac1) and c:IsLocation(LOCATION_HAND+LOCATION_EXTRA) end)
	...
	if ct>1 then
		...
		e2:SetTarget(function(_,c) return c:IsCode(ac2) and c:IsLocation(LOCATION_HAND+LOCATION_EXTRA) end)
	...
	if ct>2 then
		...
		e3:SetTarget(function(_,c) return c:IsCode(ac3) and c:IsLocation(LOCATION_HAND+LOCATION_EXTRA) end)
