...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct>0 then
		...
		e1:SetValue(function(_e,_re,_tp) return _re:GetHandler():IsCode(ac1) and _re:IsMonsterEffect() end)
	...
	if ct>1 then
		...
		e2:SetValue(function(_e,_re,_tp) return _re:GetHandler():IsCode(ac2) and _re:IsMonsterEffect() end)
	...
	if ct>2 then
		...
		e3:SetValue(function(_e,_re,_tp) return _re:GetHandler():IsCode(ac3) and _re:IsMonsterEffect() end)
