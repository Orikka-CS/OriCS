...
function s.rozespfilter(c,e,tp)
	return c:IsCode(18452889) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.thspfilter(c,e,tp,ft)
	return c:IsCode(18452889) and c:IsFaceup() and (c:IsAbleToHand()
