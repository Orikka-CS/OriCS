...
function s.initial_effect(c)
	...
	--덱에서 레벨 4 이하의 천사족 / 빛 속성 몬스터 1장 또는 카운터 함정 카드 1장을 묘지로 보낸다.
...
function s.tgfilter(c)
	return ((c:IsLevelBelow(4) and c:IsRace(RACE_FAIRY) and c:IsAttribute(ATTRIBUTE_LIGHT)) or c:IsCounterTrap()) and c:IsAbleToGrave()
end
