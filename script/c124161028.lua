...
function s.initial_effect(c)
	--effect 1
	local e1=Fusion.CreateSummonEff({handler=c,fusfilter=aux.FilterBoolFunction(Card.IsSetCard,0xf21),extrafil=s.extrafil,extraop=s.extraop,extratg=s.extratg})
	c:RegisterEffect(e1)
	--effect 2
