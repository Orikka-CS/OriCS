...
s.listed_names={11827244}
function s.tfil1(c)
	return c:IsCode(11827244) and c:IsAbleToHand()
end
...
function s.tfil2(c,e,tp)
	return c:IsRace(RACE_DRAGON) and c:IsAttribute(ATTRIBUTE_EARTH) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
