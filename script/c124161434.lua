...
function s.cst1filter(c)
	return c:IsSetCard(0xf3c) and not c:IsPublic()
end
...
function s.fcheck(tp,sg,fc)
	return sg:IsExists(Card.IsSetCard,1,nil,0xf3c,fc,SUMMON_TYPE_FUSION,tp)
end
...
function s.tg2(e,c,sump,sumtype,sumpos,targetp,se)
