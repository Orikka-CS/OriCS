...
function s.initial_effect(c)
	c:EnableReviveLimit()
	local xe1=Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_ILLUSION),4,3)
	xe1:SetD(id,0)
	local xe2=Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRace,RACE_ILLUSION),6,2)
	xe2:SetD(id,1)
