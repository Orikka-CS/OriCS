...
function s.tfil1(c)
	return c:IsSetCard(0xffe) and c:IsAbleToHand() and c:IsType(TYPE_MONSTER) and not c:IsCode(id)
end
...
function s.tar2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		return not Duel.IsPlayerAffectedByEffect(tp,CARD_BLUEEYES_SPIRIT)
			...
			and Duel.IsExistingMatchingCard(s.tfil2,tp,LOCATION_DECK,0,2,nil,e,tp)
	end
...
function s.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(s.tfil2,tp,LOCATION_DECK,0,nil,e,tp)
	if #g<2 then
		return
	end
