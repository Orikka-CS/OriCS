...
s.listed_names={124121114,124121116}
...
function s.con2(e,tp,eg,ep,ev,re,r,rp)
	...
	return ep==1-tp and loc&LOCATION_ONFIELD>0 and Duel.IsChainDisablable(ev)
end
...
function s.tfil3(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsCode(124121114,124121116)
end
