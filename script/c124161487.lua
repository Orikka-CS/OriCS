...
function s.tg1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>1
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,124161475,0xf3f,TYPES_TOKEN,300,0,1,RACE_PLANT,ATTRIBUTE_EARTH,POS_FACEUP,tp) end
...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<2
		...
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,124161475,0xf3f,TYPES_TOKEN,300,0,1,RACE_PLANT,ATTRIBUTE_EARTH,POS_FACEUP,tp) then return end
