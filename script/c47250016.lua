...
function cm.initial_effect(c)
	...
	c:EnableReviveLimit()
	Link.AddProcedure(c,nil,2,2,cm.matcheck)
...
function cm.matcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0xe2e,lc,sumtype,tp)
end

function cm.thfilter(c)
	return c:IsSetCard(0xe2e) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
