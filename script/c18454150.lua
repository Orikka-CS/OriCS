...
function s.con2(e,tp,eg,ep,ev,re,r,rp)
	...
	return rc:IsSetCard("¶óÀÏ¶ô") and re:IsActiveType(TYPE_TRAP) and re:IsHasType(EFFECT_TYPE_ACTIVATE) and c:IsReason(REASON_EFFECT)
...
function s.ocon21(e)
	...
	local b2=cc-1>0 and Duel.IsChainNegatable(cc-1) and ne and ne:IsActiveType(TYPE_SPELL)
		and ne:IsHasType(EFFECT_TYPE_ACTIVATE) and np~=tp
