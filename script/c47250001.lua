...
function cm.initial_effect(c)
	...
	e12:SetCategory(CATEGORY_TOHAND+CATEGORY_EQUIP)
...
function cm.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetEquipTarget() and Duel.IsExistingMatchingCard(cm.thfilter,tp,LOCATION_DECK,0,1,nil) end
