...
function s.con1filter(c)
	return c:IsFaceup() and not c:IsSetCard(0xf32)
end
...
function s.tg1filter(c)
	return c:IsSetCard(0xf32) and c:IsTrap() and c:IsAbleToHand() 
end
...
function s.con2(e,tp,eg,ep,ev,re,r,rp)
	return re and e:GetHandler():IsReason(REASON_COST) and re:IsActivated() and rp==tp and re:GetHandler():IsSetCard(0xf32)
end
