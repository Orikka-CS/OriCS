...
function s.initial_effect(c)
	...
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x12da),1)
...
function s.chngfilter(c)
	return c:IsSetCard(0x12da) and c:IsLinkMonster()
end
...
function s.desfilter(c,e,tp)
	return c:IsCanBeEffectTarget(e) and (c:IsControler(1-tp) or (c:IsSetCard(0x12da) and c:IsFaceup()))
end
