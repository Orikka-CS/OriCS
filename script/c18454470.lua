...
function s.initial_effect(c)
	...
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x12da),2)
...
s.listed_series={0x12da,0x2da}
s.listed_names={id,18452887,18452889} --"Sky Striker Ace - Raye", "Sky Striker Ace - Roze"
...
function s.spfilter(c,e,tp)
	return c:IsCode(18452887,18452889) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
