...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 then
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,124161200,0xf2d,TYPES_TOKEN,0,0,1,RACE_REPTILE,ATTRIBUTE_WIND)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,124161200,0xf2d,TYPES_TOKEN,0,0,1,RACE_REPTILE,ATTRIBUTE_WIND,POS_FACEUP,1-tp) and Duel.SelectYesNo(tp,aux.Stringid(id,0)) then
			Duel.BreakEffect()
			local tk1=Duel.CreateToken(tp,124161200)
			local tk2=Duel.CreateToken(tp,124161200)
