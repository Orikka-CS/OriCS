...
function s.tar1fil(c,e,tp)
	return c:IsSetCard(0x3d71) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	local sc=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.tar1fil),tp,LOCATION_HAND|LOCATION_DECK|LOCATION_GRAVE,0,1,1,nil,e,tp):GetFirst()
