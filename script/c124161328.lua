...
function s.con2filter(c)
	return c:IsFaceup() and not c:IsSetCard(0xf35)
end
...
function s.tg2filter(c)
	return c:IsSetCard(0xf35) and not c:IsCode(id) and c:IsAbleToGrave()
end
...
function s.nttg(e,c)
	return c:IsSetCard(0xf35) and c:IsLevelAbove(5)
end