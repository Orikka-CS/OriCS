...
function s.tfil2(c)
	return c:IsLevelAbove(5) and c:IsAttackBelow(2000) and c:IsRace(RACE_FAIRY) and c:IsAbleToGrave()
end
...
function s.tar4(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		return Duel.GetMZoneCount(tp,c)>0 and Duel.IsExistingMatchingCard(s.tfil4,tp,LOCATION_REMOVED,0,1,nil,e,tp)
	end
