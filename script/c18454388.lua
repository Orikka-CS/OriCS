...
function s.cfil1(c)
	return c:IsDiscardable() and (c:IsRace(RACE_FAIRY) or c:IsAttribute(ATTRIBUTE_DARK))
end
...
function s.tfil1(c,e,tp)
	return c:IsCode(18454387) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
