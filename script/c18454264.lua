...
function s.tfil2(c)
	return c:IsCode(18454265) and c:IsAbleToHand()
end
...
function s.op3(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup()
		and c:UpdateAttack(300)~=0 and c:UpdateDefense(300)~=0 then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
		local g=Duel.SMCard(tp,s.ofil3,tp,"M","M",0,1,nil,c:GetAttack())
		if #g>0 then
