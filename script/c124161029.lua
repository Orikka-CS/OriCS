...
function s.tg2filter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0xf21) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) and not c:IsReason(REASON_REPLACE) and c:IsReason(REASON_EFFECT+REASON_BATTLE)
end
